...
export default function MediaGalleryModal({ isOpen, onClose, chooseOne = false, handleSelectedFiles, selected = [] }) {
                            ...
                            //     :
                                <Tabs className="tabs" defaultIndex={0} selectedTabClassName="active" selectedTabPanelClassName="show" forceRenderTabPanel={true}>
                                    ...
                                    <TabPanel className="tab-pane">
                                        <PtDropzone onUpload={uploadImage} onRemove={removeImage} handleSelectedFiles={handleSelectedFiles} />
                                    </TabPanel>
