...
import { getCategories, getTags, getPost } from '../../../api';
...
export default function PostDetail ( props ) {
    ...
    const [ detailEdit, setDetailEdit ] = useState( EditorState.createEmpty() )
    ...
    useEffect( () => {
        setLoading( true );
        getPost( parseInt( props.match.params.id ) ).then( post => {
            setPost( post );
            setCats( post.categories.map( cat => cat.slug ) );
            setImages( post.media ? post.media : [] );
            setLoading( false );
            setDetailEdit( EditorState.createWithText( post.description ) );
        } );
    ...
    function savePost ( e ) {
        e.preventDefault();
        toast(
            <PNotify title="Success" icon="fas fa-check" text="Post saved successfully." />,
            {
                containerId: "default",
    ...
    function deletePost ( result ) {
        ...
        result && props.history.push( `${ process.env.PUBLIC_URL }/posts` );
    }

    function onDetailChange ( state ) {
        setDetailEdit( state );
    }

    return (
        <>
            <Breadcrumb current="Edit Post" paths={ [
                {
                    name: 'Home',
                    url: '/'
                }, {
                ...
                : <Form className="ecommerce-form" action="#" method="post" onSubmit={ savePost }>
                                            ...
                                            <Form.Group as={ Row } className="align-items-center">
                                                ...
                                                <Col lg={ 7 } xl={ 6 }>
                                                    <Form.Control
                                                        ...
                                                        required
                                                        value={ post.title }
                                                        onChange={ e => postChange( 'title', e.target.value ) }
                                                    />
                                                </Col>
                                            </Form.Group>
                                            <Form.Group as={ Row } className="align-items-center">
                                                ...
                                                <Col lg={ 7 } xl={ 6 }>
                                                    <Form.Control
                                                        ...
                                                        className="form-control-modern"
                                                        id="author"
                                                        defaultValue={ post.author.first_name + ' ' + post.author.last_name }
                                                        required
                                                        readOnly
                                                    />
                                                </Col>
                                            ...
                                            <Form.Group as={ Row }>
                                                ...
                                                <Col lg={ 7 } xl={ 6 }>
                                                    <Form.Control
                                                        ...
                                                        onChange={ e => postChange( 'short_desc', e.target.value ) }
                                                    />
                                                </Col>
                                            </Form.Group>
                                            <Form.Group as={ Row }>
                                    ...
                                    <Row>
                                        ...
                                        <Col lg="3-5" xl="4-5">
                                            <Form.Group as={ Row }>
                                                <Col>
                                                    <Editor
                                                        editorState={ detailEdit }
                                                        editorClassName="form-control"
                                                        editorStyle={ { minHeight: "300px" } }
                                                        onEditorStateChange={ onDetailChange }
                                                    />
                                                </Col>
                                            </Form.Group>
                                        </Col>
                    ...
                    <Row className="action-buttons">
                        ...
                        <Col md="auto" className="col-6 ml-md-auto mt-3 mt-md-0">
                            ...
                            ><i className="bx bx-trash text-4 mr-2"></i> Delete Post</Button>
                        </Col>
                    </Row>
                </Form>
            }
            ...
            <DeleteConfirmModal isOpen={ deleteModal } onClose={ deletePost } />
        </>
    )
}